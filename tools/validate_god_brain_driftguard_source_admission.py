...
EXPECTED_TOP_LEVEL_KEYS = {"schema_version", "status", "god_brain_base_head", "source_repository", "observed_source_main_head", "invariants", "sources", "god_brain_future_detector_rules", "god_brain_future_effect_rules", "claim_ceiling", "assessment_date", "snapshot_semantics"}
EXPECTED_SNAPSHOT_SEMANTICS = {"SOURCE_HEADS_AND_REVIEW_STATES_ARE_AS_OBSERVED_AT_ASSESSMENT", "SNAPSHOT_REVIEW_STATE_NE_LIVE_REVIEW_STATE", "FRESH_SOURCE_READ_REQUIRED_BEFORE_CURRENTNESS_CLAIM"}
...
EXPECTED_INVARIANTS = {
    ...
    "OBSERVED_SOURCE_STATE_NE_LIVE_CURRENTNESS",
}
...
EXPECTED_CLAIM_CEILING = {
    ...
    "NO_LIVE_SOURCE_CURRENTNESS_CLAIM",
}
...
def validate_driftguard_source_admission(root: Path) -> list[str]:
    ...
    if spec.get("assessment_date") != "2026-09-20":
        errors.append("assessment_date drifted")
    _exact_set(errors, spec.get("snapshot_semantics"), EXPECTED_SNAPSHOT_SEMANTICS, "snapshot semantics")
